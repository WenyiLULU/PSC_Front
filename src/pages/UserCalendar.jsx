...
function UserCalendar() {
  ...
  const [calendarValue, setCalendarValue] = useState([Date | null, Date | null])
  ...
  const handleSubmit = (values) => {
    // setValue(value)
    const data = {startDate: values.dates[0], endDate: values.dates[1], author: userId, actionType: values.actionType, city: values.city}
